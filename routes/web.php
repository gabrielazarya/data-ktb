...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/pkk/kelompok', [DashboardController::class, 'pkkKelompok'])->name('pkk.kelompok');
    Route::get('/pkk/pohon-pemuridan', [DashboardController::class, 'pkkPohon'])->name('pkk.pohon');
    Route::post('/pkk/kelompok/{kelompok}/laporan', [PkkReportController::class, 'store'])->name('pkk.kelompok.laporan.store');
    Route::put('/pkk/laporan/{laporan}', [PkkReportController::class, 'update'])->name('pkk.laporan.update');
    Route::delete('/pkk/laporan/{laporan}', [PkkReportController::class, 'destroy'])->name('pkk.laporan.destroy');
