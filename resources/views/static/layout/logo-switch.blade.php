  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              <a
                ...
                title="Ganti tema"
              >
                <i class="bi bi-circle-half" id="theme-toggle-icon"></i>
              </a>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="../index.html" class="brand-link logo-switch">
            ...
            <img
              src="{{ asset('assets/img/AdminLTEFullLogo.png') }}"
    ...
    <script>
      ...
      const updateThemeToggleUI = () => {
        ...
        if (icon) {
          icon.className = iconClassMap[currentTheme] || iconClassMap.auto;
        }

        document.querySelectorAll('[data-theme-value]').forEach((button) => {
          const isActive = button.getAttribute('data-theme-value') === currentTheme;
